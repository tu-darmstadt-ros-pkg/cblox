...
namespace cblox {
    ...
    class Sensor {
        public:
            ...
            bool getMessageFromQueue(std::queue<MsgType>* queue, MsgType* msg, Transformation* T_G_C);
        ...
        protected:
            ...
            std::shared_ptr<GenericSubmapCollectionIntegrator<IntegratorType, IntegrationData, VoxelType>> submap_collection_integrator_;
