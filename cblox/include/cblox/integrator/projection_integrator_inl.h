...
addBearingVectors(const Point& origin, const Pointcloud& bearing_vectors,
    ...
    for (size_t i = 0; i < bearing_vectors.size(); ++i) {
        ...
        bool success = voxblox::getSurfaceDistanceAlongRay<VoxelType1>(
            *collision_layer_, T_S2_C * origin, T_S2_C * bearing_vectors[i], max_distance_,
...
//template class cblox::ProjectionIntegrator<cblox::RGBProjectionIntegrator<voxblox::TsdfVoxel>, voxblox::TsdfVoxel, voxblox::RGBVoxel, voxblox::Color>;