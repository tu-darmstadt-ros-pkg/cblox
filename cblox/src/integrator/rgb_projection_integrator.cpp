...
RGBProjectionIntegrator(std::shared_ptr<GenericSubmapCollection<VoxelType1>> collision_collection,
    ...
    : ProjectionIntegrator<RGBProjectionIntegrator<VoxelType1>, VoxelType1, voxblox::RGBVoxel, Color>(collision_collection, data_collection)
      //msg_transformation_(msg_transformation) 
      {}

template<typename VoxelType1>
RGBProjectionIntegrator<VoxelType1>::
RGBProjectionIntegrator(ProjectionConfig<VoxelType1, voxblox::RGBVoxel, Color> config)
    : ProjectionIntegrator<RGBProjectionIntegrator<VoxelType1>, VoxelType1, voxblox::RGBVoxel, Color>(config) 
    {}
